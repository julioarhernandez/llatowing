          ...
          (e = this).each(function (t, e) {
            ...
            n
              ? (i = n[s]) && "_" != s.charAt(0)
                ...
                : c(u + " is not a valid method")
              : c(h + " not initialized. Cannot call methods, i.e. " + u);
          }),
          void 0 !== a ? a : e
        );
      }),
  ...
  (function (t, e) {
    ...
    function L(t) {
      ...
      if (
        ...
        for (
          var r = (s.isBorderBox = "border-box" == n.boxSizing), a = 0;
          a < x;
          a++
        ) {
          var u = I[a],
  ...
  (function (n, s) {
    ...
    s.extend(d, e.prototype),
      ...
      (d.dispatchEvent = function (t, e, i) {
        ...
        this.emitEvent(t, n),
          a &&
            ...
            e
              ? (((o = a.Event(e)).type = t), this.$element.trigger(o, i))
      ...
      (l.create = function (t, e) {
        var i = c(l);
        return (
          (i.defaults = s.extend({}, l.defaults)),
    ...
    !(function (e) {
      ...
      e(document).on("click", ".eael-load-more-button", function (a) {
        ...
        if (void 0 !== r && void 0 !== c) {
          ...
          if (
            "Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery" ==
            b.class
          ) {
            var h = {
            ...
            (b.taxonomy = h), (b.page = E);
          }
          if (
            ("Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery" ===
              b.class &&
              (e(".dynamic-gallery-item-inner").each(function () {
                f.push(e(this).data("itemid"));
              }),
              (y = e(".dynamic-gallery-category.active").data("termid")),
              (_ = e(".dynamic-gallery-category.active").data("taxonomy")),
              (b.page = 1),
          ...
          var C = function (e) {
            var a = e
                ...
                .find(".dynamic-gallery-category.active"),
              t = a.data("filter"),
          ...
          e.ajax({
            ...
            success: function (a) {
              var r = e(a);
              if (r.hasClass("no-posts-found") || 0 === r.length)
                "Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery" ==
                b.class
                  ? (t
                      .removeClass("button--loading")
                      .addClass("hide-load-more"),
                    o.html(l))
                  : "Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery" ==
                    b.class
                  ? (t.removeClass("button--loading"), o.html(l), C(t))
                  : t.remove();
              else {
                if (
                  ...
                  if (
                    ...
                    var n,
                      s = "eael-product-" + Date.now();
                    (n = e(".eael-product-grid .products", i).isotope())
                      .isotope("appended", r)
                      .isotope("layout"),
                      ...
                      e(".woocommerce-product-gallery." + s, i).each(
                        function () {
                    ...
                    r.find(".woocommerce-product-gallery").addClass(d),
                      r
                        .find(".woocommerce-product-gallery")
                        .addClass("eael-new-product"),
                      e(".woocommerce-product-gallery." + d, i).each(
                        function () {
                          e(this).wc_product_gallery();
                        }
                      );
                  ...
                  (e(".eael-post-appender", i).append(r), "masonry" == p)
                )
                  (n = e(".eael-post-appender", i).isotope())
                    .isotope("appended", r)
                    .isotope("layout"),
                    n.imagesLoaded().progress(function () {
                      n.isotope("layout");
                ...
                if (
                  ...
                  "Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery" ==
                  b.class
                    ? e(".eael-cat-tab li a.active", i).data("page", E)
                    : t.data("page", m),
                  "Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery" ==
                    b.class)
                ) {
                  var c = e(r[0]);
                  c.hasClass("found_posts") &&
                    c.text() - v.posts_per_page < 1 &&
                    C(t);
                } else g && b.page >= g && t.remove();
              }
            },
            error: function (e) {
              console.log(e);
