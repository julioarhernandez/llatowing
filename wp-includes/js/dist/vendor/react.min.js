    ...
    (t = function (e) {
      ...
      function o(e, t, n) {
        ...
        if (null != t)
          ...
          t))
            D.call(t, r) && !V.hasOwnProperty(r) && (o[r] = t[r]);
      ...
      function d(e) {
        for (var t = s(G); null !== t; ) {
          if (null === t.callback) p(G);
          else {
            if (!(t.startTime <= e)) break;
            p(G), (t.sortIndex = t.expirationTime), f(Y, t);
          }
          t = s(G);
        }
      }
      ...
      function v(e, t) {
        (Z = !1), ee && ((ee = !1), ne(ae), (ae = -1)), (X = !0);
        var n = Q;
        try {
          for (
            d(t), K = s(Y);
            null !== K && (!(K.expirationTime > t) || (e && !m()));

          ) {
            var r = K.callback;
            if ("function" == typeof r) {
              (K.callback = null), (Q = K.priorityLevel);
              var o = r(K.expirationTime <= t);
              (t = z()),
                "function" == typeof o ? (K.callback = o) : K === s(Y) && p(Y),
                d(t);
            } else p(Y);
            K = s(Y);
          }
      ...
      var F = (r.prototype = new n());
      (F.constructor = r), O(F, t.prototype), (F.isPureReactComponent = !0);
      var M = Array.isArray,
      ...
      var Y = [],
        ...
        Z = !1,
        ee = !1,
        te = "function" == typeof setTimeout ? setTimeout : null,
        ne = "function" == typeof clearTimeout ? clearTimeout : null,
        re = "undefined" != typeof setImmediate ? setImmediate : null;
      ...
      if ("function" == typeof re)
        ...
        var se = (F = new MessageChannel()).port2;
      ...
      (F = {
            ...
            return (
              ...
              n > r
                ? ((e.sortIndex = n),
                  ...
                  null === s(Y) &&
                    e === s(G) &&
                    (ee ? (ne(ae), (ae = -1)) : (ee = !0), h(b, n - r)))
                : ((e.sortIndex = o), f(Y, e), Z || X || ((Z = !0), _(v))),
              e
            );
          },
        ...
        (e.cloneElement = function (e, t, n) {
          ...
          if (null != t) {
            if (
              (void 0 !== t.ref && ((u = t.ref), (a = U.current)),
        ...
        (e.memo = function (e, t) {
          return { $$typeof: $, type: e, compare: void 0 === t ? null : t };
        }),
        (e.startTransition = function (e, t) {
          (t = N.transition), (N.transition = {});
          try {
            e();
          } finally {
            N.transition = t;
