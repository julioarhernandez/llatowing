  ...
  !(function () {
    ...
    function d(n) {
      const {
        ...
        c = a[a.length - 1],
        l = t.substr(c.prevOffset, o - c.prevOffset);
      l && c.children.push(l),
        c.children.push((0, e.cloneElement)(r, null, ...s)),
        (c.prevOffset = u || o + i);
    }
    var p = (n, r) => {
      if (((t = n), (o = 0), (i = []), (a = []), (u.lastIndex = 0), !c(r)))
        throw new TypeError(
      ...
      return n.reduce(
        (t, n, r) => (
          e.Children.forEach(n, (n, o) => {
            n &&
              "string" != typeof n &&
              (n = (0, e.cloneElement)(n, { key: [r, o].join() })),
              t.push(n);
          }),
          t
        ),
    ...
    function m(t, n) {
      return (
        ...
        e.Children.map(t, (t, r) => {
          if ("string" == typeof (null == t ? void 0 : t.valueOf()))
            return (0, e.createElement)(n, { key: r }, t);
    ...
    const v = (e) =>
      "number" != typeof e &&
      ("string" == typeof (null == e ? void 0 : e.valueOf()) || Array.isArray(e)
        ? !e.length
        : !e);
    var b = {
      OS: "web",
    ...
    function A(t) {
      let { children: n, ...r } = t,
        o = "";
      return (
        e.Children.toArray(n).forEach((e) => {
          "string" == typeof e && "" !== e.trim() && (o += e);
        }),
    ...
    const F = [
      ...
      U = [
        ...
        "xml:space",
        "xmlns:xlink",
      ].reduce((e, t) => ((e[t.replace(":", "").toLowerCase()] = t), e), {});
    function $(e) {
      switch (e) {
        case "htmlFor":
          return "for";
    ...
    function B(t, n) {
      ...
      if (Array.isArray(t)) return G(t, n, r);
      switch (typeof t) {
        case "string":
      ...
      switch (o) {
        case e.StrictMode:
        case e.Fragment:
          return G(i.children, n, r);
        case A:
          const { children: t, ...o } = i;
          return Y(
            Object.keys(o).length ? "div" : null,
    ...
    function Y(e, t, n) {
      ...
      if ("textarea" === e && t.hasOwnProperty("value")) {
        ...
        "string" == typeof t.dangerouslySetInnerHTML.__html
          ...
          : void 0 !== t.children && (o = G(t.children, n, r));
      if (!e) return o;
      const i = J(t);
      return j.has(e)
        ? "<" + e + i + "/>"
    ...
    function J(e) {
      ...
      for (const n in e) {
        ...
        ("boolean" != typeof o || a) &&
          ((t += " " + r),
          i ||
            ("string" == typeof o && (o = (0, T.escapeAttribute)(o)),
            (t += '="' + o + '"')));
      }
      return t;
    }
